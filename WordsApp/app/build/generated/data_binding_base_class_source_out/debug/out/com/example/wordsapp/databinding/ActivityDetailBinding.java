...
public final class ActivityDetailBinding implements ViewBinding {
  ...
  private ActivityDetailBinding(@NonNull FrameLayout rootView, @NonNull RecyclerView recyclerView) {
  ...
  public static ActivityDetailBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityDetailBinding((FrameLayout) rootView, recyclerView);
    }
